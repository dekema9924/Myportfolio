    ...
    return (
        <>
            <Fade direction='right'>
                <div className='m-auto h-80  text-white mt-20 w-11/12 text-center '>
                    <div className=' flex items-center justify-between gap-3 h-16  border-2 pl-5'>
                        ...
                        <div className='mr-10 flex gap-3'>
                            ...
                            <a target='blank' href="https://www.linkedin.com/in/daniel-ekema-44ba39225/"><LinkedInIcon className='cursor-pointer text-white hover:text-blue-700' /></a>\                        
                        </div>

                    </div>

                    <div className='border-2  flex flex-col justify-center h-full items-center'>
                        <p className='text-3xl font-bold w-96 sm:w-80  leading-10' style={{ fontFamily: "Play" }}>Hi, My Name is <span className='text-yellow-500'>Daniel</span></p>
                        ...
                        <div className=' flex gap-4 mt-5'>
                            ...
                            <div className='border-2 rounded-full '>
                                <img className='w-[80px]' src={catoonpfp} alt="" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <Education />
            <Skills />
            <h1 className='text-yellow-600 text-3xl text-center sm:mt-7' style={{ fontFamily: "Play" }}>Projects</h1>
            <p className='text-blue-300 text-center'>Check out some of my personal projects</p>
            <div className='flex gap-16  flex-wrap justify-center sm:justify-start sm:p-2 sm:gap-5 items-center mt-10'>
                <Projects
                    project="Blog Site"
                    tools="HTML, JS, MongoDB"
                ...
                <Link className='text-white flex justify-center sm:justify-start h-16  sm:ml-5 mt-5 ' to={'/allprojects'}>
                    <button type="button" className="flex items-center gap-2  px-5 py-2 border-2 border-yellow-600 rounded-lg  hover:text-yellow-800 hover:bg-blue-300 transition-all delay-100">
                        Show More
